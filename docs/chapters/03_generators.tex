...
Para cada uno se explica el mecanismo, se da un ejemplo a mano y se discute su seguridad.
El código y la ejecución que mide la complejidad lineal alcanzada están en el capítulo~\ref{cap:implementacion}.
...
La tabla siguiente compara los cuatro generadores con los parámetros que vamos a usar en el análisis experimental (capítulo~\ref{cap:analisis}).
...
En el análisis experimental, con secuencias más largas, se sigue manteniendo esta proximidad y los tres se acercan a $N/2$.
...
El análisis experimental (capítulo~\ref{cap:analisis}) lleva todo esto un paso más allá, ejecuta los cuatro generadores con secuencias más largas, mide su complejidad lineal exacta
