...
además, de un claro beneficio en el tiempo de trabajo, ya que uno empieza a usarlas como un colaborador que revisa tu trabajo, y lo emplea para contrastar, encontrar erratas o cuestionar una explicación poco clara, revisando siempre lo que devuelve.
...
También me llevo haber aprendido a manejar \LaTeX{}, una herramienta que no había usado antes de este trabajo. Y que me ha resultado muy útil para escribir la memoria de este trabajo de forma profesional.
Es una herramienta muy extendida en el ámbito académico y técnico, así que manejarla con cierta soltura es algo que me llevo en el desarrollo de la memoria de este trabajo.
...
Por encima de todo, ha sido un trabajo que he disfrutado mucho. Juntar la parte de criptografía, que siempre me había llamado la atención ya que la estudié en asignaturas como ALEM o LMD,
ha hecho que todo lo estudiado en esas asignaturas tenga sentido y se vea aplicado en un contexto real. Ver cómo la teoría se traduce en código y
cómo los resultados experimentales confirman o contradicen las expectativas teóricas ha sido muy gratificante, y me deja con ganas de seguir investigando este tipo de análisis.
